...
execute if score @s mb_build_side matches 3 run tp ^-1 ^ ^
execute if score @s mb_build_side matches 1 run tp ^ ^ ^1
execute if score @s mb_build_side matches 2 run tp ^ ^ ^-1
...
execute as @s[tag=!edta_mb_hinge] run function movable_builds:update/full_size/update_next_tilt