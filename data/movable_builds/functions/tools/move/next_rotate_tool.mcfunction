...
execute if score @s mb_move_type matches 4 run data merge entity @s {Item:{tag:{mb-move-type:5,display:{Name:"{\"text\":\"Rotate Tilted Right\"}"},CustomModelData:5420114}}}
execute if score @s mb_move_type matches 5 run data merge entity @s {Item:{tag:{mb-move-type:6,display:{Name:"{\"text\":\"Rotate Tilted Left\"}"},CustomModelData:5420115}}}
