...
scoreboard players add $blocks_scanned scan_limit 1
...
execute if entity @e[type=armor_stand, tag=edta_movable_build, tag=edta_mb_marker, distance=..0.5] run function movable_builds:scan/mark_hinge
