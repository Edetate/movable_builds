...
execute store result score @s mb_hor_rot run data get entity @s Rotation[0] 10000
execute store result score @s mb_ver_rot run data get entity @s Rotation[1] 1000000
