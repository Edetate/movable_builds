...
execute at @s as @e[type=armor_stand,tag=edta_movable_build] if score @s mb_parent_id = $parent_id mb_part_id run function movable_builds:update/full_size/do_update_tilt
