...
execute as @s[tag=!edta_mb_tilt] run function movable_builds:update/update_next
execute as @s[tag=edta_mb_tilt] run function movable_builds:update/update_next_tilt
